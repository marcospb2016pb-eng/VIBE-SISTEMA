...
@app.route('/')
def index():
    # Redireciona para o estoque para o Render detectar atividade
...
def cadastrar():
    f = request.form
    # Aceita campos vazios transformando em 0 ou texto padrão
...
if __name__ == '__main__':
    # Esta parte é ignorada pelo Gunicorn no Render, mas deixamos por segurança
